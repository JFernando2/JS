...
function formatarData(data) {
    ...
    if(data !== '') { // nesse ponto, a data vem ao contrário, por isso colocamos o método reverse
...
function formatarCPF(cpf) {
    ...
    if(cpf !== '') { // 11122233344
        let cpf_parte1 = cpf.substr(0,3); // 111
        let cpf_parte2 = cpf.substr(3,3); // 222
        let cpf_parte3 = cpf.substr(6,3); // 333
        let cpf_parte4 = cpf.substr(9,2); // 44
